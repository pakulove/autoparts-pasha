               ...
               <h4><a class="indigo-text">Данные автозапчасти:</a></h4><br>
                    <div class="row">
                        ...
                        <div class="row">
							...
							<div class="input-field col s6">
							<center><a class="waves-effect waves-light btn-large indigo" onclick="edit_autopart()" style="width:275px"><i class="material-icons left">edit</i>Изменить</a><a class="indigo-text" onclick="clear_autopart_form()"><u>или очистить форму</u></a></center>
							</div>
						</div>
						</form>
